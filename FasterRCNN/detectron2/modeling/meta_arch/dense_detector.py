...
class DenseDetector(nn.Module):
    ...
    def forward(self, batched_inputs: List[Dict[str, Tensor]]):
        ...
        features = self.backbone(images.tensor) # images.tensor.shape=[bs, c, h, w]
    ...
    def _decode_per_level_predictions(self, anchors: Boxes, pred_scores: Tensor, pred_deltas: Tensor, score_thresh: float, 
    ...
    def _decode_multi_level_predictions(self,
        ...
        predictions = [self._decode_per_level_predictions(anchors_i, box_cls_i, box_reg_i, score_thresh, topk_candidates, image_size)
