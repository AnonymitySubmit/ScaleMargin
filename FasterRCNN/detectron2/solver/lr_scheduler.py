...
class WarmupParamScheduler(CompositeParamScheduler):
    ...
    def __init__(self, scheduler: ParamScheduler, warmup_factor: float, warmup_length: float, warmup_method: str = "linear", rescale_interval: bool = False):
        """
        Args:
        ...
        super().__init__([warmup, scheduler], interval_scaling=["rescaled", "rescaled" if rescale_interval else "fixed"], lengths=[warmup_length, 1 - warmup_length])
