...
def _generate_optimizer_class_with_gradient_clipping(optimizer: Type[torch.optim.Optimizer], *,
...
def get_default_optimizer_params(
    ...
    overrides: Optional[Dict[str, Dict[str, float]]] = None) -> List[Dict[str, Any]]:
    """
    ...
    norm_module_types = (torch.nn.BatchNorm1d,
