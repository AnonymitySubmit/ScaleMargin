...
class BoxMode(IntEnum):
    ...
    def convert(box: _RawBoxType, from_mode: "BoxMode", to_mode: "BoxMode") -> _RawBoxType:
        ...
        assert to_mode not in [BoxMode.XYXY_REL, BoxMode.XYWH_REL] and from_mode not in [BoxMode.XYXY_REL, BoxMode.XYWH_REL], "Relative mode not yet supported!"
...
class Boxes:
    ...
    def cat(cls, boxes_list: List["Boxes"]) -> "Boxes":
        ...
        if len(boxes_list) == 0: return cls(torch.empty(0))
